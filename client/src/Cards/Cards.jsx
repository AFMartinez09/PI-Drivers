      ...
      <div className={style.container}>
         ...
         <div className={style.OrderAndFilter}>
            <select className={style.Order} onChange={handleOrder}>
               ...
               <option className={style.orderOption} value="Default">Restore values</option>
               <option className={style.orderOption} value="A Alphabetical">Ascending A-Z</option>
               <option className={style.orderOption} value="D Alphabetical">Descending Z-A</option>
            ...
            <select className={style.Filter} onChange={handleFilter}>
               ...
               <option className={style.filterOption} value="Default">Restore values</option>
